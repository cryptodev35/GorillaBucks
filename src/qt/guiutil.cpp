...
{
    // Convert GorillaBucks:// to GorillaBucks:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("GorillaBucks://"))
    {
        uri.replace(0, 12, "GorillaBucks:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "GorillaBucks.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("GorillaBucks-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  GorillaBucks-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("GorillaBucks-Qt"));
