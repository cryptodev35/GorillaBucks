...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Throw BUCKS to a GorillaBucks address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving GorillaBucks"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&GorillaBands"), this);
    masternodeManagerAction->setToolTip(tr("Show GorillaBand Nodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    tabGroup->addAction(masternodeManagerAction);

    messageAction = new QAction(QIcon(":/icons/edit"), tr("&GorillaGrams"), this);
    ...
    aboutAction = new QAction(tr("&About GorillaBucks"), this);
