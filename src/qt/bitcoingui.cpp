    ...
    nWeight(0)
{
	...
	masternodeManagerPage->setObjectName("MasternodeManager");
...
void BitcoinGUI::createActions()
{
    ...
    masternodeManagerAction = new QAction(tr("&GorillaBands"), this);
    masternodeManagerAction->setToolTip(tr("Show GorillaBand Nodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
	masternodeManagerAction->setProperty("objectName","masternodeManagerAction");
    tabGroup->addAction(masternodeManagerAction);

    messageAction = new QAction(tr("&GorillaGrams"), this);
    messageAction->setToolTip(tr("View and Send Encrypted messages"));
    messageAction->setCheckable(true);
	messageAction->setProperty("objectName","messageAction");
...
void BitcoinGUI::createToolBars()
{
    ...
    _addButtonInToolbar(masternodeManagerAction,toolbar);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("GorillaBucks client") + QString(" ") + tr("[testnet]"));
...
{
    QString strTitle = tr("GorillaBucks") + " - ";
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        "which is destroyed completely and paid to nobody. "
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid GorillaBucks address or malformed URI parameters."));
    }
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        labelEncryptionIcon->setToolTip(tr("Wallet is <b>encrypted</b> not <b>Encrypted</b>"));
        changePassphraseAction->setEnabled(false);
...
//    file.setFileName("themes"+QString(QDir::separator())+ name + QString(QDir::separator())+ name + ".qss");
    ...
    setMinimumSize(1200,750);  // You can remove this line just give good idea of theme at this resolution - Yash
