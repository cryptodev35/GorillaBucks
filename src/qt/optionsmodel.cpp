...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeGorillaBucksAmount"))
        settings.setValue("nAnonymizeGorillaBucksAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeGorillaBucksAmount = settings.value("nAnonymizeGorillaBucksAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeGorillaBucksAmount"))
        SoftSetArg("-anonymizeGorillaBucksamount", settings.value("nAnonymizeGorillaBucksAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeGorillaBucksAmount:
            nAnonymizeGorillaBucksAmount = value.toInt();
            settings.setValue("nAnonymizeGorillaBucksAmount", nAnonymizeGorillaBucksAmount);
            emit anonymizeGorillaBucksAmountChanged(nAnonymizeGorillaBucksAmount);
            break;
        default:
            break;
        }
