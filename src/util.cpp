...
int nAnonymizeGorillaBucksAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\GorillaBucks
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\GorillaBucks
    // Mac: ~/Library/Application Support/GorillaBucks
    // Unix: ~/.GorillaBucks
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GorillaBucks";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "GorillaBucks.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "GorillaBucksd.pid"));
